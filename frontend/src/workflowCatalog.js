...
export const REPEAT_FIELD = { key: 'repeat_every_days', label: 'Danach alle X Tage erneut erinnern (0 = nur einmal)', type: 'number', default: 0, min: 0 }
