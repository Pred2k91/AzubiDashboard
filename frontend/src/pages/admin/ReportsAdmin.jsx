    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-[#141625] rounded-xl border border-[#2a2d4a]">
        <button
          ...
          className="w-full flex items-center justify-between px-4 py-3 text-sm font-medium text-slate-400 hover:text-white"
        >
          <span>Klassische Ampel-Ansicht {showClassic ? 'ausblenden' : 'einblenden'}</span>
          {showClassic ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
        </button>
        ...
        {showClassic && (
          <div className="p-4 pt-0 space-y-4">
            ...
            {/* Azubi-Tabelle */}
            <div className="rounded-xl border border-[#2a2d4a] overflow-x-auto">
