...
import { MessageSquareText, Plus, Trash2, Star, AlignLeft, Send, RotateCcw, FlaskConical, Copy, Check } from 'lucide-react'
  ...
  return (
    <div className="bg-[#141625] rounded-xl border border-[#2a2d4a] p-5 space-y-3">
      ...
      <p className="text-xs text-slate-500">
        ...
        Der Azubi-Bogen erscheint sofort im Portal des Azubis, den Team-Link bekommst du hier direkt zum Kopieren
        (statt per Mail, falls noch kein SMTP eingerichtet ist).
      </p>
      ...
      {result && (
        <div className="border border-[#2a2d4a] rounded-lg p-3 space-y-2">
          {result.azubi_instance_id && (
            <p className="text-xs text-green-400">Azubi-Bogen angelegt -- jetzt unter "Feedback" im Portal des Azubis sichtbar.</p>
          )}
          {result.team_link ? (
            <div>
