...
export default function LoginPage() {
  ...
  return (
    <div
      className="light-theme min-h-screen w-full flex flex-col items-center justify-center bg-[#0d0f1a] bg-cover bg-center p-4"
      style={backgroundUrl ? { backgroundImage: `url(${backgroundUrl})` } : undefined}
    >
      <div className="w-full max-w-sm flex flex-col items-center gap-6">
        {logoUrl ? (
          <img src={logoUrl} alt="Logo" className="h-24 w-auto max-w-[280px] object-contain drop-shadow-xl" />
        ) : (
        ...
        <div className="w-full bg-[#141625] border border-[#2a2d4a] rounded-2xl p-8 shadow-2xl">
